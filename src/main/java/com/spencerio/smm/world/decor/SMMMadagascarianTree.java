...
public class SMMMadagascarianTree extends WorldGenerator
{
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
		...
		if (par4 >= 1 && par4 + var6 + 1 <= 256)
		{
				...
				for (int var10 = par3 - var9; var10 <= par3 + var9 && var7; ++var10)
				{
					for (var11 = par5 - var9; var11 <= par5 + var9 && var7; ++var11)
					{
						if (var8 >= 0 && var8 < 256)
						{
							...
							if (block1 != null && block1 != Blocks.vine && block1 != Blocks.grass && block1 != Blocks.dirt && block1 != Blocks.log)
							{
								var7 = false;
							}
						}
			...
			else
			{
				...
				if ((block2 == Blocks.grass || block2 == Blocks.dirt) && par4 < 256 - var6 - 1)
				{
					...
					for (var11 = 0; var11 < var6; ++var11)
					{
						...
						if (block1 == null || block1 == Blocks.leaves)
						{
						...
						for (var11 = par4 - 3 + var6; var11 <= par4 + var6; ++var11)
						{
							...
							for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
							{
								for (var15 = par5 - var13; var15 <= par5 + var13; ++var15)
								{
									...
									{
										if (par2Random.nextInt(4) == 0 && par1World.getBlock(var14 - 1, var11, var15) == null)
										{
										...
										if (par2Random.nextInt(4) == 0 && par1World.getBlock(var14, var11, var15 - 1) == null)
										{
	 ...
	 private void growVines(World par1World, int par2, int par3, int par4, int par5)
	{
		...
		while (true)
		{
			...
			if (par1World.getBlock(par2, par3, par4) != null || var6 <= 0)
			{
				return;
			}
